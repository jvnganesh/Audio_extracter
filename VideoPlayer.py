...
class VideoPlayer(QWidget):
    def __init__(self, video_path, audio_path):
        ...
        # Set a higher frame rate for smoother playback
        ...
        self.audio_thread = threading.Thread(target=self.update_audio_waveform)
    ...
    def update_audio_waveform(self):
        while True:
            ...
            self.ax.set_xlim(0, self.video_duration)
...
if __name__ == '__main__':
    ...
    source_path = 'C:/Users/lenovo/Desktop/my_proj/my.mp4'
    destination_path = 'C:/Users/lenovo/Desktop/my_proj/cleaned_audio'
